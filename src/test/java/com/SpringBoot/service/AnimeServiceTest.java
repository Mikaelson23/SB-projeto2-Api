...
class AnimeServiceTest {
    ...
    void save_ReturnsAnime_WhenSuccessful(){
        ...
        Anime anime = animeService.save(AnimePostRequestBodyCreate.createAnimeToBeSaved());
    ...
    void replace_UpdatesAnime_WhenSuccessful(){
        ...
        Assertions.assertThatCode(() ->animeService.replace(AnimePutRequestBodyCreate.createAnimeToBeUpdate()))
